...
```
/jira-analyzer-02 <TICKET_ID> [TEAM]
```

**Examples:**
- `/jira-analyzer-02 USPRTE-924` — analyzes ticket (general analysis, no team-specific dependency check)
- `/jira-analyzer-02 USPRTE-924 CARE` — analyzes ticket + checks cross-team dependencies with CARE
